(function() {
    ...
    sketch.Util = {
        ...
        resizing: function() {
            ...
            imaginaryCanvas.width = canvas_pure.width;
            imaginaryCanvas.height = canvas_pure.height

            imaginaryCanvasContext = imaginaryCanvas.getContext('2d');
            imaginaryCanvasContext.drawImage(canvas_pure,
                0,
                0,
                canvas_pure.width,
                canvas_pure.height,
            ...
            canvas_pure.height = window.innerHeight * 0.65;
            canvas_pure.width = window.innerWidth * 0.98;
            context.drawImage(imaginaryCanvas,
                0,
                0,
                imaginaryCanvas.width,
                imaginaryCanvas.height,
    ...
    //setup canvas
    canvas_pure = document.getElementById('mycanvas');
    context = canvas_pure.getContext("2d");
